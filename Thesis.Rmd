...
> as the same as, you know, a SENCO or a head teacher's views but in
...
> *Sometimes a kind of mediation role because it's, we work in complex
...
> lose the, er, being able to point at things or being able to, you
> know, look at their faces better and realise, 'Oh, they're not
...
> technologically-mediated (tech) consultations did not lead to a
> decrease in quality of the relationship. One EP experienced her
> consultees asking for telephone consultations and that these were
> effective. (Interview 1)*
...
> to again, sort of, revisit what we've discussed in the first session,
...
> might be looking for empathy, erm, and understanding, so very much
> giving that but recognising that that in itself won't necessarily move
> things on. So trying to be aware, it's very much that, sort of,
> discourse analysis, try to be aware of what the function of their use
...
> impact of a consultation can really vary. And I don't know, I don't
...
> time, allows for a flexibility. So, you know, sometimes halfway
> through a consultation, you'll discover a piece of information that is
> crucial and up until now completely unknown, and you can change tack.
> You can do something different. (Interview 2)*
...
the voice of the child: *"being quite child centred... bringing the
...
One of the main ways in which interviewees talked about changing perspectives was around *"extending the thought processes of the people involved"* (Interview 10). The goal of the EP was to help *"[reframe] to a certain extent, how they perceive the situation or how we understand it together"* and *"not [think] about a problem within a child, but thinking about a young person and how they interact with the environment that they are in"* (Interview 13). 
